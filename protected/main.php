...
<body>
    <div class="top">
        <div class="container">
            <div class="social">
                ...
                <div class="top-b"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/Twitter.png" alt="Curso" class="img-rounded"></div>
                <div class="top-c"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/Facebook.png" alt="Curso" class="img-rounded"></div>
                <div class="top-d"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/mensaje.png" alt="Curso" class="img-rounded"></div>
            </div>
        </div>
    </div>
    <div class="logo">
    ...
    <nav id="nav">
       ...
       <ul>
            ...
            <li><?php echo Chtml::link('Jurado',array('/site/page/view/jurado'))?></li>
    ...
    <?php  if(Yii::app()->request->url == array('/amway/')&& !Yii::app()->user-id){?>  
          ...
          <div class="textboxint">
                    <div class="text">
                        ...
                        <span style="float:right;">
                            <?php echo CHtml::link('LEER MAS...',array('contenido/'.$latestNews->id),array('class'=>'LeeMas')); ?>
                        </span>
            ...
            <div class="tips2">
                    ...
                    <span style="margin-left:20px; ">   
                        <?php  if(Yii::app()->user->isSuperAdmin){
                            echo Chtml::link('User Manager',array(Yii::app()->user->ui->userManagementAdminUrl),array('class'=>'user-manager'));
                        }  ?>
                    </span>   
            </div>
        </div>
         ...
         <div class="submenu">
            <div class="row-fluid">
                            ...
                            <div class="span">
                                    ...
                                    <span1><?php echo Chtml::link('Jurado',array('/site/page/view/jurado'))?></span1>
