...
<div class="row">
   ...
   <div class="col-lg-6"><span><h1>Línea  del Tiempo</h1></span></div>
...
<script type="text/javascript">
  ...
  ocultarlinea(2016);
   ...
   <div class="col-lg-2"></div>
    <div class = "col-lg-8">
          <div class="imagenlinea"><img src="<?php echo Yii::app()->baseUrl;?>/images/LineaDelTiempo.png" border="0" usemap="#Map" id="line-time"/></div>
      </div>
   <div class="col-lg-2"></div>
 ...
 <map name="Map" id="Map" style="cursor: pointer;">
          <area shape="circle" coords="21,20,79,77" onclick="mostrarlineaActual(1998)" />
          <area shape="rect" coords="86,135,131,179" onclick="mostrarlineaActual(1999)" />
          <area shape="rect" coords="149,23,194,65" onclick="mostrarlineaActual(2000)" />
          <area shape="rect" coords="214,135,258,178" onclick="mostrarlineaActual(2001)" />
          <area shape="rect" coords="272,22,325,68" onclick="mostrarlineaActual(2002)" />
          <area shape="rect" coords="339,134,386,180" onclick="mostrarlineaActual(2003)" />
          <area shape="rect" coords="397,21,445,71" onclick="mostrarlineaActual(2004)" />
          <area shape="rect" coords="461,132,511,181" onclick="mostrarlineaActual(2005)" />
          <area shape="rect" coords="525,27,575,69" onclick="mostrarlineaActual(2006)" />
          <area shape="rect" coords="87,133,633,178" onclick="mostrarlineaActual(2007)" />
          <area shape="rect" coords="651,26,699,68" onclick="mostrarlineaActual(2008)" />
          <area shape="rect" coords="653,336,698,375" onclick="mostrarlineaActual(2009)" />

          <area shape="rect" coords="584,228,639,267" onclick="mostrarlineaActual(2010)" />
          <area shape="rect" coords="526,332,576,388" onclick="mostrarlineaActual(2011)" />
          <area shape="rect" coords="461,223,512,263" onclick="mostrarlineaActual(2012)"/>
          <area shape="rect" coords="398,333,446,381" onclick="mostrarlineaActual(2013)" />
          <area shape="rect" coords="337,222,384,267" onclick="mostrarlineaActual(2014)" />
          <area shape="rect" coords="275,332,321,379" onclick="mostrarlineaActual(2015)" />
      <area shape="rect" coords="214,221,259,267" onclick="mostrarlineaActual(2016)" />
    </map>

 <div class="col-lg-2"></div>   

<div class="col-lg-8 line-time-text" id="texto_linea" style="display:none; height:100%">
     ...
     <div id="anio_2010" style="display:none">
       ...
       <div id="anio_2011" style="display:none">
        ...
        <div id="anio_2013" style="display:none">
          ...
          temerle, Édison  Arley Bolaños Angulo.
          </p>
