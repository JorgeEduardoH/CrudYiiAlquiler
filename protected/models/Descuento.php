 ...
 * @property integer $Descuento_Descuento
 */
class Descuento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_Descuento', 'required'),
			array('id_Descuento, Descuento_Descuento', 'numerical', 'integerOnly'=>true),
			array('fecha_Descuento', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_Descuento, fecha_Descuento, Descuento_Descuento', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'Descuento_Descuento' => 'Descuento Descuento',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('Descuento_Descuento',$this->Descuento_Descuento);
