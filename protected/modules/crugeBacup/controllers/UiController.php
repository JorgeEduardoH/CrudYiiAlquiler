    ...
    public function actionLogin()
    {
        ...
        if (isset($_POST[CrugeUtil::config()->postNameMappings['CrugeLogon']])) {
            ...
            if ($model->validate()) {
				...
				$this->redirect(Yii::app()->request->baseUrl.'/site/index?m=4');
            }
        }
       ...
       // $this->layout= "/layouts/vacio";
        ...
        if (isset($_POST[CrugeUtil::config()->postNameMappings['CrugeLogon']])) {
            ...
            if ($model->validate()) {
				...
				//$this->redirect(Yii::app()->request->baseUrl.'/site/index?m=6');
				...
				$this->redirect(Yii::app()->request->baseUrl.'/site/index?m=5');
			}
        }
